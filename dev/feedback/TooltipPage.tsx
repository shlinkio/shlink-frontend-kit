...
import { Button, Tooltip, useTooltip } from '../../src';
  ...
  return (
    <div className="flex flex-col gap-y-4">
      <div className="flex flex-col gap-y-2">
        <h2>Tooltip</h2>
        <div {...main.anchor} className="border p-2">Hover me</div>
        <Tooltip {...main.tooltip}>Hello!!</Tooltip>
      </div>

      <div className="flex flex-col gap-y-2">
        <h2>Tooltip that can be hovered</h2>
        <div {...keepOpen.anchor} className="border p-2">
          Hover me
      ...
      <div className="flex flex-col gap-y-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-2">
          <div>
            <div {...bottom.anchor} className="border p-2">Bottom - Hover me</div>
            <Tooltip {...bottom.tooltip}>Bottom</Tooltip>
          </div>
          <div>
            <div {...top.anchor} className="border p-2">Top - Hover me</div>
            <Tooltip {...top.tooltip}>Top</Tooltip>
          </div>
          <div>
            <div {...left.anchor} className="border p-2">Left - Hover me</div>
            <Tooltip {...left.tooltip}>Left</Tooltip>
          </div>
          <div>
            <div {...right.anchor} className="border p-2">Right - Hover me</div>
      ...
      <div className="flex flex-col gap-y-2">
        <h2>Rich tooltip</h2>
        <div {...rich.anchor} className="border p-2">Hover me</div>
      ...
      <div className="flex flex-col gap-y-2">
        ...
        <div {...content.anchor} className="border p-2">Hover me</div>
