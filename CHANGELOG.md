...
### Fixed
* Set `scope="col"` to `Table.Cell` when used in the header and the `scope` prop has not been explicitly provided.
...
### Fixed
* [#589](https://github.com/shlinkio/shlink-frontend-kit/issues/589) Return focus to dropdown toggle button when menu is closed.
